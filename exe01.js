...
>>>>>>> 27729099b65f28a53964f19274f451c76a722500
                ...
                vendas = []
                for(x = 1; x <= meses; x++){
                    vendas.push(Number(prompt("Valor vendido por "+objeto.nome+" no mes "+x+": R$")))
                }
                objeto.valor = vendas
            ...
            case 3:
                ...
                for(i = 0;i < vendedor.length; i++){
                    if(cod == vendedor[i].codigo){
                        mes = Number(prompt("Mês desejado: ")) //janeiro = 0
                        mes = mes - 1 //necessario pois começa no 0
                        alert("Vendedor -- "+vendedor[i].nome+
                        "\nTotal das vendas no mes"+(mes+1)+": R$"+vendedor[i].valor[mes].toFixed(2))
                    }
                }
                break;
            case 4:
...
>>>>>>> 27729099b65f28a53964f19274f451c76a722500
            ...
            case 6:
                for(x = 0; x < meses; x++){
                    for(i = 0; i < vendedor.length;i++){ //inicia em janeiro
